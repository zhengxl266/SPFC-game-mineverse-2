...
def generate_quiz():
    ...
    try:
        ...
        try:
            ...
            # For testing purposes, provide a fallback quiz
            quiz_data = {
                "quiz": [
                    {
                        "question": "What type of energy is generated by wind turbines?",
                        "options": ["A. Solar energy", "B. Wind energy", "C. Nuclear energy", "D. Geothermal energy"],
                        "correct_answer": "B"
                    },
                    {
                        "question": "Which technology converts sunlight directly into electricity?",
                        "options": ["A. Wind turbines", "B. Hydroelectric dams", "C. Photovoltaic cells", "D. Steam engines"],
                        "correct_answer": "C"
                    },
                    {
                        "question": "What is used to create reservoirs in hydroelectric power plants?",
                        "options": ["A. Solar panels", "B. Wind turbines", "C. Dams", "D. Nuclear reactors"],
                        "correct_answer": "C"
                    },
                    {
                        "question": "Why are renewable energy sources important for the environment?",
                        "options": ["A. They are cheaper", "B. They reduce greenhouse gas emissions", "C. They are more efficient", "D. They are easier to install"],
                        "correct_answer": "B"
                    },
                    {
                        "question": "Where are wind turbines typically installed?",
                        "options": ["A. In underground caves", "B. In dense forests", "C. In coastal regions or open plains", "D. In urban centers"],
                        "correct_answer": "C"
                    }
                ]
            }
        ...
        for i, question_data in enumerate(quiz_questions):
            ...
            if not is_correct and user_answer:
                try:
                    ...
                    # Provide a basic explanation when API fails
                    result['explanation'] = f"The correct answer is {correct_answer}. Please review the source material for more details."
